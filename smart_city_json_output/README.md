...
This readme describes the json output schemas that we standardized for AITRIOS AI models. Current json output is mainly for DNN object detection and post-processing for smart city use-cases such as traffic counting and curb management.
